...
|spring.cloud.consul.health-indicator.enabed | true | If ConsulHealthIndicator should be enabled
|spring.cloud.consul.health-indicator.include-services-query | true | If ConsulHealthIndicator shouldinclude a query for registrered services.
