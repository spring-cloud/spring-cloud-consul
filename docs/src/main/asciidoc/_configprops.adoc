...
|spring.cloud.consul.ribbon.enabled | true | Consul Ribbon is controlled by two properties, spring.cloud.consul.enabled and spring.cloud.consul.ribbon.enabled |
