...
public class ConsulConfigServerBootstrapperNoConfigClientTests {
	...
	public void enabledAddsInstanceProviderFn() {
		new SpringApplicationBuilder(TestConfig.class).properties("spring.cloud.config.discovery.enabled=true",
				"spring.cloud.service-registry.auto-registration.enabled=false").run().close();
	}
