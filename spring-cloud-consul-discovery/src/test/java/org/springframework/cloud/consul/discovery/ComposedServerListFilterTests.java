...
@WebAppConfiguration
@Slf4j
public class ComposedServerListFilterTests {
	@Autowired
	ConsulClient consul;
	...
	public void setUp() throws Exception {
		...
		filter = new MultipleServerListFilter(
				new NonCriticalServerListFilter(),
				new AliveServerListFilter(new FilteringAgentClient(consul)),
				new TopByHealthServerListFilter(consul));
