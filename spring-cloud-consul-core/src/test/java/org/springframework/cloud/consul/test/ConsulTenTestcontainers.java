...
public class ConsulTenTestcontainers implements ApplicationContextInitializer<ConfigurableApplicationContext> {

	static final Logger logger = LoggerFactory.getLogger(ConsulTenTestcontainers.class);

	public static GenericContainer<?> consul = new GenericContainer<>("consul:1.10")
	...
	public void initialize(ConfigurableApplicationContext context) {
		...
		if (!sources.contains("consulTenTestcontainer")) {
			...
			sources.addFirst(new MapPropertySource("consulTenTestcontainer", map));
		}
	}
