...
/**
 * A kv store watch that publishes an EnvironmentChangeEvent whenever a value
 * under one of the property sources is changed
 * @author Andrew DePompa
 */
@Slf4j
public class ConsulConfigWatch implements ApplicationEventPublisherAware {
