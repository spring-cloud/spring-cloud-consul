...
@SpringApplicationConfiguration(classes = {ConsulConfigWatchTest.MyTestConfig.class, org.springframework.cloud.consul.config.util.ConsulConfigTestUtil.EnvironmentChangeEventHandler.class})
